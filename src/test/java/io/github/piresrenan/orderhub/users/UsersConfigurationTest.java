...
class UsersConfigurationTest {
    ...
    void composesUsersModuleThroughExplicitSpringBeans() {
        ...
        // Covers: repositories, use cases and identity generator wired from one
        // explicit Users module composition root.
        // Prevents: annotation-driven framework coupling spreading through the
        // module internals.
